...
/****** Object:  StoredProcedure [dbo].[SP_Patient_Lab_Requests_Invoice_Mandatory]    Script Date: 31-Dec-19 11:38:14 AM ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
ALTER PROCEDURE [dbo].[SP_Patient_Lab_Requests_Invoice_Mandatory](@WaitingID int , @ClinicID int)
...
FROM     dbo.FeesMandatory INNER JOIN
                  ...
                  dbo.FeeCategoryFactor ON dbo.FeesMandatory.FeeMandatoryGroupID = dbo.FeeCategoryFactor.FeeMandatoryGroupID AND dbo.DoctorGP.CategoryID = dbo.FeeCategoryFactor.CategoryID
